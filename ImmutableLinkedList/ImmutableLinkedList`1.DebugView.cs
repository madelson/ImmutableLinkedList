...
public partial struct ImmutableLinkedList<T>
{
    ...
    /// </summary>
    internal sealed class DebugView(ImmutableLinkedList<T> list)
    {
        private readonly ImmutableLinkedList<T> _list = list;

        public int Count => this._list.Count;
        public object? Head => this._list.Count > 0 ? this._list.Head : "{list is empty}";
        public object Tail => this._list.Count > 0 ? this._list.Tail : "{list is empty}";
